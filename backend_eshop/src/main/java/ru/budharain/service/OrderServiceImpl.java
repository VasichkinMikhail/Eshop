...
public class OrderServiceImpl implements OrderService {
    ...
    public void createOrder(String username) {
        ...
        List<OrderLineItems> orderLineItems = cartService.getLineItems()
                .stream()
                .map(li -> new OrderLineItems(
                        null,
                        order,
